...
dataSet[dataSetVersion].options = [
  {
    ...
    checked: true,
    sub: [
      { name: "A1 瑪莉的鍊金工房 ～薩爾布魯克的鍊金術士～", key: "A1", checked: false },
      { name: "A2 艾莉的鍊金工房 ～薩爾布魯克的鍊金術士2～", key: "A2", checked: false },
      { name: "A3 莉莉的鍊金工房 ～薩爾布魯克的鍊金術士3～", key: "A3", checked: false },
      { name: "A4 尤蒂的鍊金工房 ～格拉姆納特的鍊金術士～", key: "A4", checked: false },
      { name: "A5 薇歐蕾特的鍊金工房 ～格拉姆納特的鍊金術士2～", key: "A5", checked: false },
      { name: "A6 伊莉絲的鍊金工房 ～永恆瑪娜～", key: "A6", checked: false },
      { name: "A7 伊莉絲的鍊金工房 ～永恆瑪娜2～", key: "A7", checked: false },
      { name: "A8 伊莉絲的鍊金工房 ～偉大的幻影～", key: "A8", checked: false },
      { name: "A9 瑪娜傳奇 ～學園的鍊金術士們～", key: "A9", checked: false },
      { name: "A10 瑪娜傳奇2 ～衰落的學園與鍊金術士們～", key: "A10", checked: false },
      { name: "A11 蘿樂娜的鍊金工房 ～亞蘭德之鍊金術士～", key: "A11", checked: false },
      { name: "A12 托托莉的鍊金工房 ～亞蘭德之鍊金術士2～", key: "A12", checked: false },
      { name: "A13 梅露露的鍊金工房 ～亞蘭德之鍊金術士3～", key: "A13", checked: false },
      { name: "A14 愛夏的鍊金工房 ～黃昏大地之鍊金術士～", key: "A14", checked: false },
      { name: "A15 愛絲卡&羅吉的鍊金工房 ～黃昏天空之鍊金術士～", key: "A15", checked: false },
      { name: "A16 夏莉的鍊金工房 ～黃昏海洋之鍊金術士～", key: "A16", checked: false },
      { name: "A17 蘇菲的鍊金工房 ～不可思議書的鍊金術士～", key: "A17", checked: false },
      { name: "A18 菲莉絲的鍊金工房 ～不可思議旅的鍊金術士～", key: "A18", checked: false },
      { name: "A19 莉迪&蘇瑞的鍊金工房 ～不可思議繪畫的鍊金術士～", key: "A19", checked: false },
      { name: "A20 露露亞的鍊金工房 ～亞蘭德之鍊金術士4～", key: "A20", checked: false },
      { name: "A21 萊莎的鍊金工房 ～常暗女王與秘密藏身處～", key: "A21", checked: false },
      { name: "A22 萊莎的鍊金工房2 ～失落傳說與秘密妖精～", key: "A22", checked: false },
      { name: "A23 蘇菲的鍊金工房2 ～不可思議夢的鍊金術士～", key: "A23", checked: false },
      { name: "A24 萊莎的鍊金工房3 ～終結之鍊金術士與秘密鑰匙～", key: "A24", checked: false },
      { name: "A25 蕾斯萊莉婭娜的鍊金工房", key: "A25", checked: false },
      { name: "A26 優米雅的鍊金工房 ～追憶之鍊金術士與幻創之地～", key: "A26", checked: false },
      { name: "Nelke 奈爾克與傳說之鍊金術士們  ～新大地之鍊金工房 ～", key: "Nelke", checked: false },
      { name: "DSA1 莉慈的鍊金工房 ～奧魯多魯的鍊金術士～", key: "DSA1", checked: false },
      { name: "DSA2 安妮的鍊金工房 ～塞拉島的鍊金術士～", key: "DSA2", checked: false },
      { name: "DSA3 莉娜的鍊金工房 ～修特拉爾的鍊金術士～", key: "DSA3", checked: false },
      { name: "AO 布蕾塞爾的鍊金術士", key: "AO", checked: false },
      { name: "Elkrone 艾爾克羅奈的鍊金工房 ～Dear for Otomate～", key: "Elkrone", checked: false },
    ],
  },
  {
    name: "排除次要角色",
